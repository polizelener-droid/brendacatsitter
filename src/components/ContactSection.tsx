  ...
  return (
    <section id="contacto" className="bg-[#e2e8dc] py-12 sm:py-14">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] border border-[#275240]/15 bg-[#e2e8dc] p-6 text-center sm:p-8">
          ...
          <div className="mx-auto mt-6 grid max-w-xl gap-3 sm:grid-cols-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl border border-[#275240]/20 bg-[#e2e8dc] px-5 py-3 text-sm font-bold text-[#275240] transition hover:bg-[#d7dfd1]"
            >
