        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          {services.map((service: ServiceItem) => (
            ...
            >
              ...
              <div>
                <h3 className="text-sm font-bold text-[#132E35] mb-1 font-display">{service.title}</h3>
                <p className="text-[#3B5259] text-xs leading-relaxed">{service.description}</p>
                {service.highlight && (
        ...
        <div className="bg-gradient-to-br from-white via-[#EBF7F6] to-[#E0F2F1] text-[#132E35] rounded-3xl p-6 sm:p-8 shadow-sm relative overflow-hidden border border-[#CCE7E5]">
          <div className="relative z-10">
            <div className="mb-8 pb-5 border-b border-[#CCE7E5]">
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#132E35] font-display">Tarifas de las Visitas</h3>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <div className="bg-white/95 p-5 rounded-2xl border border-[#CCE7E5] shadow-2xs">
                ...
                <div className="text-2xl sm:text-3xl font-black text-[#132E35] font-display">{rates.weekday}</div>
              ...
              <div className="bg-white/95 p-5 rounded-2xl border border-[#CCE7E5] shadow-2xs">
                ...
                <div className="text-2xl sm:text-3xl font-black text-[#132E35] font-display">{rates.saturday}</div>
                <p className="text-xs text-[#3B5259] mt-1">Por visita de 45 minutos</p>
              </div>
              <div className="bg-white/95 p-5 rounded-2xl border border-[#CCE7E5] shadow-2xs">
                <div className="flex items-center gap-2 text-[#0B8276] text-xs font-bold mb-1.5">
                ...
                <div className="text-2xl sm:text-3xl font-black text-[#132E35] font-display">{rates.sundayHoliday}</div>
                <p className="text-xs text-[#3B5259] mt-1">Por visita de 45 minutos</p>
              </div>
              <div className="bg-[#DDF2F0]/90 p-5 rounded-2xl border border-[#B2DDD9] shadow-2xs">
                ...
                <div className="text-2xl sm:text-3xl font-black text-[#132E35] font-display">{rates.interview}</div>
                <p className="text-xs text-[#3B5259] font-medium mt-1 leading-relaxed">{rates.interviewDesc}</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 pt-6 border-t border-[#CCE7E5]">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#3B5259] leading-relaxed">{rates.keyHandover}</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#E0F2F1] text-[#0B8276] flex items-center justify-center shrink-0 border border-[#B2DDD9] mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#3B5259] leading-relaxed">{rates.paymentTerms}</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#E0F2F1] text-[#0B8276] flex items-center justify-center shrink-0 border border-[#B2DDD9] mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#3B5259] leading-relaxed">{rates.cancellationPolicy}</p>
                </div>
              </div>
            </div>
